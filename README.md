...
Documentación del proyecto: [FLUJO_APLICACION.md](./documentacion/FLUJO_APLICACION.md)
...
| **Testing Library** | Testing unitario de componentes - Documentación en este documento [README_TESTS.md](./README_TESTS.md) |
